        ...
        success: function (data2) {
            if(data2.res==0){
                ...
                for (i; i < length; i++) {
                    ...
                    var str = "最后更新时间: "+vccreattime+"\n"+"备份路径: "+vcStorepath;
                    string +="<li class='vcip_li' title='"+str+"' data-type='"+type+"' data-time='"+vccreattime+"' data-path='"+vcStorepath+"'><span class='vcid_li'>" + vcid + "</span><img src='media/image/vmware.png'>" + vcip + "</li>"
                }
...
$("#vmware-list").on("click",".vcip_li",function () {
    ...
    if($('.detailsSpan').length===0){
        let spanStr = "<span class='detailsSpan'\n" +
            "             \">最后更新时间: <font class='detailsSpanTime detailsSpanFont'>"+time+"</font>\n" +
            "备份路径: <font class='detailsSpanPath detailsSpanFont'>"+path+"</font></span>";
        $('#detailsSpanH4').append(spanStr)
    }
    else{
        $('.detailsSpanTime').text(time);
        ...
        success: function (data2) {
            if(data2.res==0){
                ...
                for (i; i < length; i++) {
                    ...
                    var vmused = parseFloat(((data[i]['vmused']/1024)/1024)/1024).toFixed(1)+"(GB)"
                    if (isbackup == "0") {
